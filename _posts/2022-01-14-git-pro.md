...
This question was particularly interesting and unique as this is different from a usual challenge like checking git history to find if there are any leaked secrets or flags hidden. Let's get into how I solved this one.
...
After a ton of googling and reading through git documentation pages, A way to search all git commits for a string was discovered as below but with no luck.
`git log -S flag`
